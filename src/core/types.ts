...
export interface IPostRequest<Params extends Record<string, string>, Body extends Record<string, unknown>> extends IRequest<Params, Body, {}> {
    type: HttpMethod.POST;
}
export interface IPutRequest<Params extends Record<string, string>, Body extends Record<string, unknown>> extends IRequest<Params, Body, {}> {
    type: HttpMethod.PUT;
}
export interface IDeleteRequest<Params extends Record<string, string>, Body extends Record<string, unknown>> extends IRequest<Params, Body, {}> {

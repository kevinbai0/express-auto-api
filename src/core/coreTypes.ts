// middleware type?
export type MiddlewareFunction = (...middleware: Handler[]) => {
    middleware: Handler[];
    subendpoints: SubendpointsFunction;
    endpoints: EndpointsFunction;
};
export type SubendpointsFunction = (...subendpoints: EndpointsBuilderResult[]) => {
    middleware: Handler[];
...
export type Handler<Res = {}, Req extends IRequest = IRequest> = (req: IExpressRequest<Req>, res: IExpressResponse<IResponse<Res | undefined>>, next: NextFunction) => Promise<void> | void;
